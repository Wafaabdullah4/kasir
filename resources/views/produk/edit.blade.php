        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="p-6">
                ...
                <form action="{{ route('produk.update', $produk->produkid) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="namaproduk" class="block text-sm font-medium text-gray-700">Nama produk:</label>
                        <input type="text" id="namaproduk" name="namaproduk" value="{{ $produk->namaproduk }}" class="mt-1 p-2 border rounded-md w-full">
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="block text-sm font-medium text-gray-700">Harga:</label>
                        <input type="number" id="harga" name="harga" value="{{ $produk->harga }}" class="mt-1 p-2 border rounded-md w-full">
                    </div>
                    <div class="mb-3">
                        <label for="stok" class="block text-sm font-medium text-gray-700">Stok:</label>
                        <input type="number" id="stok" name="stok" value="{{ $produk->stok }}" class="mt-1 p-2 border rounded-md w-full">
                    </div>
                    <div class="mt-4">
